...
-- Task 6:
select case
    when avg(salary) - avg(cast(replace(salary,"0","") as decimal)) > round(avg(salary) - avg(cast(replace(salary,"0","") as decimal)),0) then round(avg(salary) - avg(cast(replace(salary,"0","") as decimal)),0) + 1
    else round(avg(salary) - avg(cast(replace(salary,"0","") as decimal)),0)
end
from employees
